  ...
  return (
    <div className="print-sheet border-[3px] border-dashed border-ink bg-newsprint-white p-7">
      <div className="flex flex-wrap items-baseline justify-between gap-3 border-b-2 border-ink pb-3">
        ...
        <p className="font-label text-[0.8rem] font-semibold uppercase tracking-[0.16em] text-cherry">
          Subscription Order Form
        </p>
      </div>

      <dl className="mt-6 space-y-5 font-body text-[1rem]">
        {[
          ["Name", "sm:w-full"],
          ...
          <div key={label}>
            <dt className="font-label text-[0.78rem] uppercase tracking-[0.14em] text-ink-faint">
              {label}
            </dt>
      ...
      <fieldset className="mt-7 border-t border-rule pt-5">
        ...
        <p className="font-label text-[0.78rem] uppercase tracking-[0.14em] text-ink-faint">
          Circle one
        </p>
        <ul className="mt-3 space-y-2.5 font-body text-[1.05rem]">
      ...
      <div className="mt-7 grid gap-6 border-t-2 border-ink pt-5 sm:grid-cols-2">
        ...
        <div>
          ...
          <address className="mt-1.5 font-body text-[1.05rem] not-italic leading-relaxed">
      ...
      <p className="mt-6 border-t border-rule pt-4 font-body text-[0.95rem] leading-relaxed text-ink-muted">
