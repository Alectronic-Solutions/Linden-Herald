    ...
    <div className="wrap py-10">
      ...
      <div className="grid gap-14 lg:grid-cols-12">
        <div className="lg:col-span-7">
          <section>
            <h2 className="font-display text-2xl font-black drop-rule">Who are we?</h2>
          ...
          <section className="mt-12">
            ...
            <p className="mt-5 font-body text-[1.05rem] leading-[1.75] text-ink-soft">
              The people who put out the paper, and what each of them covers.
            </p>
          ...
          <section className="mt-12">
            <h2 className="font-display text-2xl font-black drop-rule">What are we?</h2>
            <p className="mt-5 font-body text-[1.05rem] leading-[1.75] text-ink-soft">
          ...
          <section className="mt-12">
            <h2 className="font-display text-2xl font-black drop-rule">
          ...
          <section className="mt-12">
            <h2 className="font-display text-2xl font-black drop-rule">Where are we located?</h2>
            <p className="mt-5 font-body text-[1.05rem] leading-[1.75] text-ink-soft">
