  ...
  return (
    <div className="wrap py-10">
      <PageHeader
        ...
        blurb="Call at any hour with a news tip, a correction, or anything else. If we miss you, we return calls as soon as we are back."
      />
      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <section className="lg:col-span-7">
          ...
          <p className="mt-3 max-w-xl font-body text-[1rem] leading-relaxed text-ink-muted">
            Tips, photographs, calendar items, letters to the editor and corrections all land in the
            same inbox, and a person reads every one.
          </p>
          <div className="mt-8">
